...
/**
 * Namespace for all things related to statistics.
 * @namespace statistic
 *
 * @playground
...
/**
 * Evaluate the correlation amongst two sets of values.
 *
 * @since 0.8.0
 * @param {Number[]} setA A set of values
 * @param {Number[]} setB Another set of values
 * @return {Number} The computed correlation
 * @playground
 * var numbers = require('numbers')
 * numbers.statistic.correlation([1,4,5,20,3], [1,3,2,5,10])
 */
